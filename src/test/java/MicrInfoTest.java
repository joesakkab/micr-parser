...
class MicrInfoTest {
    ...
    @MethodSource("micrs")
    void MicrTest(String countryName, String micr, MicrInfoDto expectedInfo,
        ...
        assertEquals(expectedInfo.getMicrStatus(), actualInfo.getMicrStatus_().name());
    }
    ...
    private static Stream<Arguments> micrs() {
        return Stream.of(
                Arguments.of("Oman", "<00002019<:02=0003:00000010220474< 001",
                        new MicrInfoDto("00002019", "02", "0003", "00000010220474", "001", "FULLY_READ"), "Fully Read"),
                Arguments.of("Oman", "<12345678<:41=0003:34345354645656< 222",
                        new MicrInfoDto("12345678", "41", "0003", "34345354645656", "222", "FULLY_READ"), "Fully Read"),
                Arguments.of("Oman", "<<:02=0003:00000010220474< 001",
                        new MicrInfoDto(null, "02", "0003", "00000010220474", "001", "PARTIALLY_READ"), "Partially Read"),
                Arguments.of("Oman", "<00002019<:=0003:00000010220474< 001",
                        new MicrInfoDto("00002019", null, "0003", "00000010220474", "001", "PARTIALLY_READ"), "Partially Read"),
                Arguments.of("Oman", "<00002019<:02=0003:< 001",
                        new MicrInfoDto("00002019", "02", "0003", null, "001", "PARTIALLY_READ"),"Partially Read"),
                Arguments.of("Oman", "<<:=:<", new MicrInfoDto("CORRUPTED"), "Corrupted"),
                Arguments.of("Oman", "<<", new MicrInfoDto("CORRUPTED"),"Corrupted"),

                Arguments.of("United Arab Emirates", "<00002019:01340003:<00000010220474< 001",
                        new MicrInfoDto("00002019", "34", "0003", "00000010220474", "001", "FULLY_READ"), "Fully Read"),
                Arguments.of("United Arab Emirates", "<12345678:01934903:<34345354645656<",
                        new MicrInfoDto("12345678", "93", "4903", "34345354645656", null, "FULLY_READ"), "Fully Read"),
                Arguments.of("United Arab Emirates", "<00002019::<00000010220474< 001",
                        new MicrInfoDto("00002019", null, null, "00000010220474", "001", "PARTIALLY_READ"), "Partially Read"),
                Arguments.of("United Arab Emirates", "<:01934903:<34345354645656<",
                        new MicrInfoDto(null, "93", "4903", "34345354645656", null, "PARTIALLY_READ"), "Partially Read"),
                Arguments.of("United Arab Emirates", "<:01:<<", new MicrInfoDto("CORRUPTED"), "Corrupted"),
                Arguments.of("United Arab Emirates", "<:01<", new MicrInfoDto( "CORRUPTED"),"Corrupted"),

                Arguments.of("Bahrain", "<000013<09=01:0001077181611<01",
                        new MicrInfoDto("000013", "09", "01", "0001077181611", "01", "FULLY_READ"), "Fully Read"),
                Arguments.of("Bahrain", "<0000713<06=54:00010771611<43",
                        new MicrInfoDto("0000713", "06", "54", "00010771611", "43", "FULLY_READ"), "Fully Read"),
                Arguments.of("Bahrain", "<<09=01:<01",
                        new MicrInfoDto(null, "09", "01", null, "01", "PARTIALLY_READ"), "Partially Read"),
                Arguments.of("Bahrain", "<<=54:00010771611<43",
                        new MicrInfoDto(null, null, "54", "00010771611", "43", "PARTIALLY_READ"), "Partially Read"),
                Arguments.of("Bahrain", "<<=:<", new MicrInfoDto("CORRUPTED"),"Corrupted"),
                Arguments.of("Bahrain", "<=:<", new MicrInfoDto( "CORRUPTED"), "Corrupted")
